...
public class KlasemenMain {
    public static void main(String[] args) {
        ...
        // Urutkan pembalap berdasarkan poin total (dari besar ke kecil)
        listPembalap.sortPembalapByPoinTotal();
        //listPembalap = sortPembalapByPoinTotal(listPembalap);

        // Tampilkan klasemen
        System.out.println("\nKlasemen MotoGP Musim 2024 - GP Qatar:");
        ...
        System.out.println("\nKlasemen MotoGP Musim 2024 - GP Portugal:");
        listPembalap.tampilkanKlasemen(listPembalap);
    }
}